...
export const ja: Translation = {
	...
	// 動画設定
	[Key.videoSettings]: "動画設定",
	[Key.videoPause]: "動画を一時停止",
	[Key.videoSwitch]: "動画を切り替え",
	[Key.videoCarousel]: "動画カルーセル",
	...
	// クラウドギャラリー
	[Key.cloudGallery]: "クラウドギャラリー",
	[Key.cloudGalleryDescription]: "クラウド画像の閲覧と管理",
	[Key.cloudGalleryLoading]: "読み込み中...",
	[Key.cloudGalleryError]: "読み込み失敗",
	[Key.cloudGalleryEmpty]: "画像がありません",
	[Key.cloudGalleryRetry]: "再読み込み",
	[Key.cloudGalleryUpload]: "アップロード",
	...
	[Key.cloudGalleryUploadPending]: "待機中",
	[Key.cloudGalleryUploadClearDone]: "完了を削除",
	[Key.cloudGalleryUploadAdd]: "追加",
	[Key.cloudGalleryImages]: "枚の画像",
	[Key.cloudGalleryPage]: "ページ",
	[Key.cloudGalleryLocalAlbums]: "ローカルアルバム",
	[Key.cloudGalleryCloudAlbums]: "クラウドギャラリー",
