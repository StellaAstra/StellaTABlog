...
export const ru: Translation = {
	...
	[Key.cloudGalleryRetry]: "Повторить",
	[Key.cloudGalleryUpload]: "Загрузить",
	...
	[Key.cloudGalleryUploadFailed]: "Ошибка",
	[Key.cloudGalleryUploadPending]: "Ожидание",
	[Key.cloudGalleryUploadClearDone]: "Очистить завершённые",
	[Key.cloudGalleryUploadAdd]: "Добавить",
	[Key.cloudGalleryImages]: "изображений",
	[Key.cloudGalleryPage]: "стр.",
	[Key.cloudGalleryLocalAlbums]: "Локальные альбомы",
	[Key.cloudGalleryCloudAlbums]: "Облачная галерея",
