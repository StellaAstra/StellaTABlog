...
updated: 2025-10-17
description: "了解 Stella 中的 Markdown 功能"
image: ""
tags: [演示, 示例, Markdown, Stella]
category: "文章示例"
draft: false
---
...
使用代码 `::github{repo="StellaAstra/StellaTABlog"}` 创建 GitHub 仓库卡片。
...
Stella 采用了 [rehype-callouts](https://github.com/lin-stephanie/rehype-callouts) 插件，支持了三种风格的提醒框主题：`GitHub`、`Obsidian` 和 `VitePress`。您可以在 `src/config/siteConfig.ts` 中进行配置：
