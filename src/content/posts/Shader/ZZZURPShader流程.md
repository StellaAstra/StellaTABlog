...
![](ZZZURPShaderOld/image-0.png)

### 关闭贴图压缩

![](ZZZURPShaderOld/image-1.png)

### 面部光照图去SRGB

![](ZZZURPShaderOld/image-2.png)

### 各类遮罩图也需要去SRGB

![](ZZZURPShaderOld/image-3.png)

## 2.Shader处理 （BaseShader部分）

### 添加KeywordEnum对各个部分进行区分，具体参数请看下面代码

![](ZZZURPShaderOld/image-4.png)
...
最后进行输出  
![](ZZZURPShaderOld/image-9.png)

![](ZZZURPShaderOld/image-10.png)

描边颜色x0.2压暗，除了面部为FF8181,其余先调成555555  
![](ZZZURPShaderOld/image-11.png)
...
我们看一下效果  
![](ZZZURPShaderOld/image-12.png)可以看到细节还有不够

下面我们来添加法线和漫反射偏移  
法线贴图是这几张图，法线在RG通道，B通道是漫反射偏移，其实就是增亮暗部的颜色

R通道  
![](ZZZURPShaderOld/image-13.png)  
G通道  
![](ZZZURPShaderOld/image-14.png)  
B通道  
![](ZZZURPShaderOld/image-15.png)
...
![](ZZZURPShaderOld/image-17.png)

![](ZZZURPShaderOld/image-18.png)
...
![](ZZZURPShaderOld/image-19.png)

![](ZZZURPShaderOld/image-20.png)
...
![](ZZZURPShaderOld/image-21.png)

![](ZZZURPShaderOld/image-22.png)
...
![](ZZZURPShaderOld/image-23.png)

![](ZZZURPShaderOld/image-24.png)
...
![](ZZZURPShaderOld/image-25.png)

![](ZZZURPShaderOld/image-26.png)
...
![](ZZZURPShaderOld/image-27.png)

稍微增大_AlbedoSmoothness，边缘变软就出现了区域

![](ZZZURPShaderOld/image-28.png)

模型的_AlbedoSmoothness为0.1

![](ZZZURPShaderOld/image-29.png)

##### SSS和albedoShallow一起输出

![](ZZZURPShaderOld/image-30.png)

![](ZZZURPShaderOld/image-31.png)
...
![](ZZZURPShaderOld/image-32.png)

![](ZZZURPShaderOld/image-33.png)
...
![](ZZZURPShaderOld/image-34.png)

![](ZZZURPShaderOld/image-35.png)
...
![](ZZZURPShaderOld/image-37.png)

![](ZZZURPShaderOld/image-38.png)

### 使用FrameDebug查看是否正常启用

![](ZZZURPShaderOld/image-39.png)
...
![](ZZZURPShaderOld/image-46.png)

![](ZZZURPShaderOld/image-47.png)

这里有3张MatCap,分别对应是高光，金属，丝袜

![](ZZZURPShaderOld/image-48.png)

先把贴图上上

![](ZZZURPShaderOld/image-49.png)
...
![](ZZZURPShaderOld/image-52.png)

![](ZZZURPShaderOld/image-53.png)

#### 衣服身体部分

![](ZZZURPShaderOld/image-54.png)
...
![](ZZZURPShaderOld/image-55.png)

#### 衣服部分

![](ZZZURPShaderOld/image-56.png)

#### 丝袜部分

![](ZZZURPShaderOld/image-57.png)
...
![](ZZZURPShaderOld/image-58.png)

#### 金属图，G通道

注意这里的金属度图并非是非0和1，大概是64/255这个样子，应该是想表达带漆面的金属效果一类

![](ZZZURPShaderOld/image-59.png)

#### 高光Mask，B通道

![](ZZZURPShaderOld/image-60.png)

#### 光滑度信息在下方的贴图的G通道中

![](ZZZURPShaderOld/image-61.png)

#### Smoothnesss，G通道

![](ZZZURPShaderOld/image-62.png)
...
![](ZZZURPShaderOld/image-65.png)  
对比一下下面效果（可能不是特别明显）  
无环境光

![](ZZZURPShaderOld/image-66.png)  
有环境光

![](ZZZURPShaderOld/image-67.png)  
确实不明显哦，可以把天空球的强度拉高点

![](ZZZURPShaderOld/image-68.png)  
可以看到环境光的效果明显了很多
...
![](ZZZURPShaderOld/image-78.png)  
眼睛部分虽然可以都设为同一的蒙版值，但最好还是区分一下，从里到外递增，判断条件都是大于等于 眼睛 !

![](ZZZURPShaderOld/image-79.png)  
内高光和外高光

![](ZZZURPShaderOld/image-80.png)  
眼影

![](ZZZURPShaderOld/image-81.png)  
现在就有了透过头发的效果了，但是没有颜色，原因和上面说的一样，深度剔除给剔除了  
当当效果出来了，但是想要变成下面的效果还有一个关键的一步那就是眼睛重绘，我们继续往下讲

![](ZZZURPShaderOld/image-82.png)
...
![](ZZZURPShaderOld/image-83.png)

这里进行透明度设置，以及蒙版值，之前设置的眼睛部分最小的蒙版值是眼睛的也就是2，所以这里设置为小于2的值就好了

![](ZZZURPShaderOld/image-84.png)

## 最终成品效果

![](ZZZURPShaderOld/image-85.png)
